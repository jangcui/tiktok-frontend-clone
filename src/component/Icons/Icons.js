...
export const ScrollIcon = ({ width = '16px', height = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ArrowIcon = ({ height = '24px', width = '24px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const EditAvatarIcon = ({ height = '18px', width = '18px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
///////////////////////////
export const WarningIcon = ({ height = '16px', width = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TagIcon = ({ height = '16px', width = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SwitchIcon = ({ height = '16px', width = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
        ...
        // class="svg-inline--fa fa-arrows-up-down "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 256 512"
    >
...
export const VideoIcon = ({ height = '16px', width = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
